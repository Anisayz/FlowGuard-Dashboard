      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', alignItems: 'flex-end' }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
          ...
          <input
            ...
            type="text" placeholder="ex. 192.168.1.100"
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
          <label style={{ color: '#8888aa', fontSize: '11px' }}>Commutateur</label>
          <select style={{ ...inputStyle, width: '120px' }} value={newRule.dpid}
        ...
        {newRule.action === 'ratelimit' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
            <label style={{ color: '#8888aa', fontSize: '11px' }}>Débit (kbps)</label>
            <input
