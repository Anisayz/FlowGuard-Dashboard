  ...
  return (
    <div style={{ fontFamily: 'monospace', color: '#e0e0ff' }}>
      ...
      <div style={sectionStyle}>
        {sectionHeader('sdn', <Server size={18} color="#00ff88" />, 'Contrôleur SDN (Ryu)', uiRyuState(health.ryu) || health.ryu || '—', health.controller === 'healthy')}
          ...
          <div style={{ padding: '20px' }}>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              <tbody>
                ...
                {typeof engineInfo.rate_limit_default_kbps === 'number' && row('Limite de débit par défaut (kbps)', engineInfo.rate_limit_default_kbps, '#ffaa00')}
                ...
                {typeof engineInfo.endpoints === 'object' &&
                  engineInfo.endpoints !== null &&
                  !Array.isArray(engineInfo.endpoints) &&
                  row(
                    'Points d’accès',
